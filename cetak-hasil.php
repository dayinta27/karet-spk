...
$kriteria_types   = $data_hasil['kriteria_types']; 
$kriteria         = $data_hasil['kriteria_data'];
$n                = $data_hasil['n'];
$m                = $data_hasil['m'];
...
$D_plus_petani    = $data_hasil['D_plus_petani'];        
$D_minus_petani   = $data_hasil['D_minus_petani'];       
$C_petani         = $data_hasil['C_petani']; 
